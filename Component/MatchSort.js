...
const Login7 = () => {
  ...
  async function fetchData() {
    try {
      ...
      const res = await axios.post("api/matchUser", { token,data });
        ...
        <div className="container">
          <div className="row justify-content-center">
            ...
            <form className="input-sec">
              ...
              <h3 className="heading-text pink-text mt-2">TOTAL MATCHES</h3>
  
              <div className="name-sec" style={{ margin: '20px 0' }}>
                {/* Separate row for "No of total User" */}
                <div className="row">
                  <div className="col">
                    <h6 className="item-text">No of total Matches:</h6>
                  </div>
                  <div className="col">
                    <p>{totalUserCount}</p>
                  </div>
                ...
                <div className="row">
                  <div className="col">
                    <h6 className="item-text">No of Matches of Today:</h6>
                  </div>
                  <div className="col">
                    <p>{todayUserCount}</p>
                  </div>
