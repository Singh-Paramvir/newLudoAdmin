  ...
  useEffect(() => {
    ...
    async function fetchCurrentData() {
      try {
        ...
        let res = await axios.post("/api/getgamezop", { token: token,data1 });
 ...
 async function onSubmitHandler(event) { 
  console.log("function hit");
    ...
    var token = localStorage.getItem("token");
      ...
      const res = await axios.post("/api/updateadddata1",{ token: token, data });
        ...
        <div class="container">
          <div class="row justify-content-center">
            ...
            <form class="input-sec">
              ...
              <h3 class="heading-text pink-text mt-2">GAMEZOP ADDS DATA</h3>
